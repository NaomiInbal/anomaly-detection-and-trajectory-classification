...
# DataBase - "tracks_database.csv",optimizer='adam'
# Improvement 1: initial_learning_rate = 0.001
...
# Improvement 2: total_nodes = 128,num_epochs = 1000
...
# Improvement 3: DataBase - the big DB - "big_data_model.csv", num_epochs = 100
...
# the big DB - "big_data_model.csv", optimizer='adam'
# Improvement 4: hidden_layers = 2 (Adding one more lstm layer)
...
# Improvement 5: optimizer='Adagrade'
...
# the big DB - "big_data_model.csv", optimizer='Adagrade'
# Improvement 6: optimizer='Adagrade', initial_learning_rate = 0.01
